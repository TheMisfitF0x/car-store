...
class CarModel
{
    ...
    public function list_car() {
        ...
        while ($obj = $query->fetch_object()) {
            $car = new Car(stripslashes($obj->Vin), stripslashes($obj->CarName), stripslashes($obj->Model), stripslashes($obj->Brand), stripslashes($obj->ManYear), stripslashes($obj->Color), stripslashes($obj->MPG), stripslashes($obj->Image));
    ...
    public function update_car($id) {
        ...
        //execute the query
        return $this->dbConnection->query($sql);//if the script did not receive post data, display an error message and then terminate the script immediately
        if (!filter_has_var(INPUT_POST, 'vin') ||
            !filter_has_var(INPUT_POST, 'car_name') ||
            !filter_has_var(INPUT_POST, 'model') ||
            !filter_has_var(INPUT_POST, 'brand') ||
